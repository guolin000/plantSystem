  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline" style="padding: 5px">
        <input type="text" name="countyId" autocomplete="off" class="layui-input layui-input-inline"
               placeholder="请输入县目编号" style="height: 30px;border-radius: 10px">
      </div>
    </div>
    <div class="layui-inline">
      ...
      <div class="layui-input-inline" style="padding: 5px">
        <input type="text" name="countyName" autocomplete="off" class="layui-input layui-input-inline"
               placeholder="请输入县名称" style="height: 30px;border-radius: 10px">
      </div>
    </div>
  ...
  <form class="layui-form" lay-filter="dataFrm" id="dataFrm" style="margin-right: 20px">
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input type="text" name="countyId" readonly placeholder="请输入县编号" autocomplete="off" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
      <label class="layui-form-label">县名称:</label>
...
<script type="text/javascript">
  ...
  layui.use(['jquery', 'layer', 'form', 'table', 'laydate', 'upload'], function () {
    ...
    tableIns = table.render({
      ...
      , url: '/county/countyList.action' //数据接口
      , title: '县信息'//数据导出来的标题
      ...
      , page: true  //是否启用分页
      , cols: [[   //列表数据
        {field: 'countyId', title: '县编号', align: 'center'}
    ...
    $("#doSearch").click(function () {
      ...
      //alert(params);
      tableIns.reload({
        url: "/county/countyList.action?" + params,
        page: {curr: 1}
      })
    });
    ...
    table.on('tool(newsTable)', function (obj) {
      ...
      if (layEvent === 'del') { //删除
        layer.confirm('真的删除【' + data.countyName+ '】这个县以及对应的信息么？', function (index) {
          //向服务端发送删除指令
          $.post("/county/deleteCounty.action", {countyId: data.countyId}, function (res) {
            layer.msg(res.msg);
            //刷新数据表格
            tableIns.reload();
          })
