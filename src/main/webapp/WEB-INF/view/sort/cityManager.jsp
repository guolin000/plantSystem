...
<div id="newsBar" style="display: none;">
  <c:if test="${role==1}">
    ...
    <a class="layui-btn layui-btn-normal layui-btn-xs layui-btn-radius" lay-event="genus">增加县</a>
  </c:if>
</div>
<!-- 修改市的弹出层-->
  ...
  <form class="layui-form" lay-filter="dataFrm" id="dataFrm" style="margin-right: 20px">
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input type="text" name="cityId" readonly placeholder="请输入市编号" autocomplete="off" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
      <label class="layui-form-label">市名称:</label>
